...
1. Verify that your project has enough quota in your region of choice for:
   * A Cloud TPU slice, for example v6e-128 (`TPUS_PER_TPU_FAMILY`)
   * Compute Engine API quota for M4 machine configuration for 224 chips (`M4_CPUS`)
...
4. Access to MoonshotAI models on Hugging Face.
   To access the [Kimi-K2-Thinking](https://huggingface.co/moonshotai/Kimi-K2-Thinking) model through Hugging Face, you'll need a Hugging Face token. Follow these steps to generate a new token if you don't have one already:
...
Define the following environment variables with values in `run.sh` appropriate to your workload:
...
- `CLUSTER_CKPT_NODE_DISK_SIZE`: The disk size of CPU nodepool used for checkpoint conversion. For this recipe, a minimum of 8TB disk size is suggested.
...
This step requires an `m4-ultramem-224` (memory-optimized) machine with 8TB of storage that can be run. The recipe uses a [Cloud Batch job](https://cloud.google.com/batch/docs/get-started) to run the conversion.

The following job performs following steps:
- Downloads Kimi K2 (defined by `HF_MODEL_NAME`) weights from HuggingFace.
...
``` bash
NAME                      READY   STATUS    RESTARTS   AGE
jetstream-pathways-0      4/4     Running   0          140m
jetstream-pathways-0-1    1/1     Running   0          140m
jetstream-pathways-0-10   1/1     Running   0          140m
jetstream-pathways-0-11   1/1     Running   0          140m
jetstream-pathways-0-12   1/1     Running   0          140m
jetstream-pathways-0-13   1/1     Running   0          140m
jetstream-pathways-0-14   1/1     Running   0          140m
jetstream-pathways-0-15   1/1     Running   0          140m
jetstream-pathways-0-16   1/1     Running   0          140m
jetstream-pathways-0-17   1/1     Running   0          140m
jetstream-pathways-0-18   1/1     Running   0          140m
jetstream-pathways-0-19   1/1     Running   0          140m
jetstream-pathways-0-2    1/1     Running   0          140m
jetstream-pathways-0-20   1/1     Running   0          140m
jetstream-pathways-0-21   1/1     Running   0          140m
jetstream-pathways-0-22   1/1     Running   0          140m
jetstream-pathways-0-23   1/1     Running   0          140m
jetstream-pathways-0-24   1/1     Running   0          140m
jetstream-pathways-0-25   1/1     Running   0          140m
jetstream-pathways-0-26   1/1     Running   0          140m
jetstream-pathways-0-27   1/1     Running   0          140m
jetstream-pathways-0-28   1/1     Running   0          140m
jetstream-pathways-0-29   1/1     Running   0          140m
jetstream-pathways-0-3    1/1     Running   0          140m
jetstream-pathways-0-30   1/1     Running   0          140m
jetstream-pathways-0-31   1/1     Running   0          140m
jetstream-pathways-0-32   1/1     Running   0          140m
jetstream-pathways-0-4    1/1     Running   0          140m
jetstream-pathways-0-5    1/1     Running   0          140m
jetstream-pathways-0-6    1/1     Running   0          140m
jetstream-pathways-0-7    1/1     Running   0          140m
jetstream-pathways-0-8    1/1     Running   0          140m
jetstream-pathways-0-9    1/1     Running   0          140m
```
...
curl --request POST --header "Content-Type: application/json" -s localhost:8000/generate --data '{
    "prompt": "<|im_system|>system<|im_middle|>You are Kimi, an AI assistant created by Moonshot AI.<|im_end|><|im_user|>user<|im_middle|>What is the capital of France?<|im_
end|><|im_assistant|>assistant<|im_middle|><think></think><|im_end|><|im_assistant|>assistant<|im_middle|>",
    "max_tokens": 800
}' | jq -r '.response'
```

You can run this script on your local machine to get the chat template.
